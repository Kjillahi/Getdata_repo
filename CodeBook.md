...
Raw data are obtained from UCI Machine Learning repository. *Human Activity Recognition Using Smartphones Data Set* [[1](#uci-har)],
...
values of estimated mean and standard deviation .
...
Some labels given from the original collectors were changed:
...
The data set is written to the file sensor_data.txt.

References
----------

1.  <a name="uci-har"/>Human Activity Recognition Using Smartphones Data Set.
    URL: <http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones>. Accessed 25/09/2015