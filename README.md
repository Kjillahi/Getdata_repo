...
Data Scientist Specialization [Link data](coursera.org)
========================================
...
* __CodeBook.md__: information about raw and tidy data set and elaboration made to
  transform them
* __CodeBook.html__: information about raw and tidy data set and elaboration made to
  transform them
* __sensor_data.txt__: Text File
* __README.md__: this file
* __run_analysis.R__: R script to transform raw data set in a tidy one

## How to create the tidy data set

1. clone this repository: `git clone git@github.com:Kjillahi/Getdata_repo.git`
